...
class PetBehavior:
    ...
    def tell_funny_story(self):
        ...
        # Show immediate feedback and animation
        self.pet.show_excited()  # Get excited about story time
        self.update_interaction_time()
        ...
        def get_funny_story():
            ...
            try:
                ...
                self.pet.last_message_time = time.time()
                print("✅ Funny story displayed immediately")
                ...
                fallback_stories = [
                    "📚 Once upon a time, I tried to catch my own tail for 3 hours... turns out I don't have one! �✨",
                    "📖 Story time! I attempted to make friends with your antivirus software, but it kept calling me 'suspicious activity'! 🛡️😤",
                    "📚 I discovered I could dance, so I spent all night practicing... your CPU wasn't happy about the 100% usage! 💃🔥",
                    "📖 True story: I tried to eat a pixel cookie, but it was just a cursor! My teeth still hurt! 🍪😭",
                    "📚 I once got into an argument with Siri about who's the better AI assistant. Let's just say I won by being cuter! 😎💅"
                ]
                
                fallback_story = random.choice(fallback_stories)
                self.pet.show_speech_bubble(fallback_story)
                print(f"✅ Fallback story displayed: {fallback_story[:50]}...")
